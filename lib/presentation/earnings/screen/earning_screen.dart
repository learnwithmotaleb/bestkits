...
class _EarningScreenState extends State<EarningScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (_ctrl.isLoading.value && _ctrl.earningModel.value == null) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_ctrl.isLoading.value) ...[
              ...
              ] else if (_ctrl.paymentHistoryList.isEmpty) ...[
                Container(
                ...
                ListView.separated(
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  itemCount: _ctrl.paymentHistoryList.length,
                  separatorBuilder: (_, __) =>
                      SizedBox(height: Dimensions.h(12)),
                  itemBuilder: (_, i) {
                    return EaringCardWidget(data: _ctrl.paymentHistoryList[i]);
                  },
                )
              ],
            ],
