...
class CartOrderSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final allItems = controller.cartModel.value?.data?.sellerGroups
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Subtotal
            _summaryRow(AppStrings.subtotal.tr,
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    Text('${AppStrings.shippingFee.tr} ',
                        style:
            ...
            // Total
            _summaryRow(
                AppStrings.total.tr, '€${controller.total.toStringAsFixed(2)}',
                bold: true),
