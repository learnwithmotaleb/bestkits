  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (controller.isLoading.value && controller.orders.isEmpty) {
        return const Center(
          child: AppLoading(isFullPage: false),
        );
      }
            ...
            child: SizedBox(
              ...
              child: Center(
                child: AppEmptyState(
                  ...
                  title: '${AppStrings.noOrderFound.tr} (${controller.tabs[controller.selectedTab.value].tr})',
                  subtitle: "There are no orders in this section.",
                ),
              ),
            ),
          ),
