class AppStrings {
  static const String appName = "BestKits";
  ...
  static const String loginSubtitle = "Log in to continue using BestKid";
  ...
  static const String signupSubtitle = "Sign up to start using BestKid";
